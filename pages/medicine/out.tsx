...
export default function MedicineOut() {
  ...
  const data = [
    {id: 1, name: "Obat Sakit Perut", unit: "Pill", price: 18000, qty: 3234, sub_total: 18000 * 3234, created_at: "05, Juni 2023 12:24 WIB"},
    {id: 2, name: "Oskadon", unit: "Tablet", price: 6000, qty: 43, sub_total: 6000 * 43, created_at: "05, Juni 2023 12:24 WIB"},
    {id: 3, name: "Antangin", unit: "Sirup", price: 25000, qty: 20, sub_total: 25000 * 20, created_at: "05, Juni 2023 12:24 WIB"}
  ];
        ...
        <div className="col-lg-12 order-0">
          <div className="card">
            <div className="card-body">
              <h4 className="mb-3">Obat Keluar</h4>
